...
The exact Member-3 workflow runner requested later is:
...
Exact requested workflow files:
...
- `results.csv`
- `threshold_plot.png`
- `four_code_comparison.png`
- `figures/theory_expected_error_rates.png`
- `figures/perfect_code_useful_region.png`
- `figures/scaling_surface_code_model.png`
- `figures/qec_process_flow.png`
- `figures/project_workflow_roadmap.png`
...
The four-code comparison plot is generated as `four_code_comparison.png`. It automatically uses teammate CSV files if present:

- `data/member1_shor.csv`
- `data/member2_steane.csv`
- `data/member4_bacon_shor.csv`

If those files are missing, it uses clearly labelled proxy curves so the final plot layout is ready without pretending those are final teammate results.
